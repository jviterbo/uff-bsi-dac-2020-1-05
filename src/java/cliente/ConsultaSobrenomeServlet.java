 ...
 * @author viter
 */
@WebServlet(name = "ConsultaSobrenomeServlet", urlPatterns = {"/ConsultaSobrenomeServlet"})
public class ConsultaSobrenomeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(ConsultaSobrenomeServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Entradas com sobrenome " + request.getParameter("sobrenome") + "</h1>");
            out.println("<ul>");
